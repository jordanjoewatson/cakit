...
from ui.custom_widgets.cakit_table_model import CakitTableModel
from ui.custom_widgets.cakit_table_view import CakitTableView
...
class CakitTableWidget(QWidget):
    ...
    def __init__(self, data_model, parent=None):
        ...
        self.model = CakitTableModel()

        self.data_model.record_added.connect(self.model.add_record)


        # self.table_view = QTableView()
        self.table_view = CakitTableView(self.model)
        self.table_view.table_record_deleted.connect(self.data_model.delete_record)
        self.table_view.signal_send_to_decrypt.connect(self.data_model.update_decrypt_record)
